REM 温馨提示：
REM	在flash的参数名upload_url中可自行定义一些参数（请求方式：GET），定义后在服务器端获取即可，比如可以应用到用户验证，文件的保存名等。
...
Partial Class Upload
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
		...
		For Each FieldName In Request.Files.AllKeys
			...
			REM 原始图片(file 域的名称：__source，如果客户端定义可以上传的话，可在此处理）。
			...
			REM 头像图片(file 域的名称：__avatar1,2,3...)。
			Else
