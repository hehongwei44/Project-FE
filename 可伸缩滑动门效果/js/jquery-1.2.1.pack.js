 ...
 * 
 * Copyright (c) 2007 John Resig (jquery.com) Dual licensed under the MIT
 * (MIT-LICENSE.txt) and GPL (GPL-LICENSE.txt) licenses.
 * 
 * $Date: 2007-09-16 23:42:06 -0400 (Sun, 16 Sep 2007) $ $Rev: 3353 $
 */
	...
	if ( elem ) with ( jQuery.browser ) {
		...
		// Otherwise loop through the offsetParents and parentNodes
			...
			while ( offsetParent ) {
				...
				// Safari <= 2 doubles body offsets with an absolutely
				// positioned element or parent
