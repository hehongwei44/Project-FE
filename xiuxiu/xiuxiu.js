...
var swfobject = function() {
    ...
    function v(ac, Y, ad, ab) {
        ...
        if (!n || G != X) {
            var Z = C("style");
            Z.setAttribute("type", "text/style");
...
xiuxiu.lightEditor = xiuxiu.lightEditor || {url: "http://open.web.meitu.com/sources/light/PhotoEditor.swf?version=201404111126",base: "http://open.web.meitu.com/sources/light/",width: "528",height: "385",type: 1};
xiuxiu.lightPuzzle = xiuxiu.lightPuzzle || {url: "http://open.web.meitu.com/sources/puzzle/CollagePlugin.swf?version=201305211645",base: "http://open.web.meitu.com/sources/puzzle/",width: "528",height: "470",type: 2};
xiuxiu.richEditor = xiuxiu.richEditor || {url: "http://xiuxiu.web.meitu.com/Main.swf?v=2.6.100",base: "http://xiuxiu.web.meitu.com/",width: "100%",height: "100%",type: 3};
xiuxiu.daitoutie = xiuxiu.daitoutie || {url: "http://open.web.meitu.com/sources/daitoutie/FacePhoto.swf?version=201304251419",base: "http://open.web.meitu.com/sources/daitoutie/",width: "568",height: "478",type: 4};
xiuxiu.avatarEditor = xiuxiu.avatarEditor || {url: "http://open.web.meitu.com/sources/avatar/avatar.swf?version=201405071529",base: "http://open.web.meitu.com/sources/avatar/",width: "700",height: "435",type: 5};
xiuxiu.batchEditor = xiuxiu.batchEditor || {url: "http://xiuxiu.web.meitu.com/plugin/batch/plugin.swf?version=201404011423",base: "http://xiuxiu.web.meitu.com/plugin/batch/",width: "700",height: "435",type: 6};
xiuxiu.uploadType = 1;
...
xiuxiu.unstatAPI = [];
xiuxiu.flashvars = {};
xiuxiu.flashvars.defaultvars = {source: "plugin",initFun: "xiuxiu._init",changeFlashHeightFun: "xiuxiu._setHeight",mouseWheelFun: "xiuxiu._mouseWheel",imageLoadedFun: "xiuxiu._imageLoaded",uploadFun: "xiuxiu._upload",beforeUploadFun: "xiuxiu._beforeUpload",uploadResponseFun: "xiuxiu._uploadResponse",batchUploadResponseFun: "xiuxiu._batchUploadResponseFun",batchUploadCompleteFun: "xiuxiu._batchUploadCompleteFun",saveBase64ImageFun: "xiuxiu._saveBase64Image",browseFun: "xiuxiu._browse",browseCancelFun: "xiuxiu._browseCancel",closePhotoEditorFun: "xiuxiu._close",debugFun: "xiuxiu._debug"};
xiuxiu.params = {menu: "false",scale: "noScale",allowFullscreen: "true",allowScriptAccess: "always",bgcolor: "#FFFFFF",wmode: "window"};
xiuxiu.embedSWF = function(b, c, f, l, e) {
    ...
    xiuxiu.swfs.push({id: xiuxiu.attributes.id,type: xiuxiu.editorType});
...
xiuxiu._batchUploadResponseFun = function(b, a, c) {
    if (xiuxiu.onBatchUploadResponse && typeof (xiuxiu.onBatchUploadResponse) == "function") {
        ...
        return {"continue": true,success: true}
    }
};
